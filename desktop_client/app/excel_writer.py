...
# 高亮色
GREEN_FILL = PatternFill(start_color="DCFCE7", end_color="DCFCE7", fill_type="solid")    # 预算增加
RED_FILL = PatternFill(start_color="FEE2E2", end_color="FEE2E2", fill_type="solid")      # 预算减少
ORANGE_FILL = PatternFill(start_color="FFF7ED", end_color="FFF7ED", fill_type="solid")    # 否词
BLUE_FILL = PatternFill(start_color="EFF6FF", end_color="EFF6FF", fill_type="solid")      # 拆精准
PURPLE_FILL = PatternFill(start_color="F5F3FF", end_color="F5F3FF", fill_type="solid")    # 页面优先
YELLOW_FILL = PatternFill(start_color="FEFCE8", end_color="FEFCE8", fill_type="solid")    # 缺失数据

# ACOS高亮
ACOS_HIGH_FILL = PatternFill(start_color="FCA5A5", end_color="FCA5A5", fill_type="solid")
ACOS_LOW_FILL = PatternFill(start_color="86EFAC", end_color="86EFAC", fill_type="solid")
ZERO_ORDER_FILL = PatternFill(start_color="FDBA74", end_color="FDBA74", fill_type="solid")
...
def _auto_width(ws, min_width: int = 8, max_width: int = 40):
    ...
    for col_idx in range(1, ws.max_column + 1):
        ...
        max_len = min_width
        for row_idx in range(1, min(ws.max_row + 1, 100)):  # 只检查前100行
...
class ExcelReportWriter:
    ...
    def write_simple_report(self, sheets: Dict[str, tuple]) -> str:
        ...
        for sheet_name, (headers, rows) in sheets.items():
            ws = wb.create_sheet(sheet_name[:31])  # Sheet名最长31字符
